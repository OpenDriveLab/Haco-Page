...
const demos = [
  { id: 'poker', button: 'Insert Poker Cards', title: 'Insert Poker Cards · Multi-Contact Friction', videos: ['/videos/benchmark/poker/2.mp4', '/videos/benchmark/poker/3.mp4'], ood: [null, 'Long-horizon'], description: 'Begin with two playing cards lying on the black platform. Use the right hand to pick up one card and transfer it to the left hand. Hold the first card upright and steady with the left hand. Then use the right hand to pick up the remaining card, align it with the card held in the left hand, and slide it into the same grip so that both cards are held together. Finish with both cards securely held in the left hand and the right hand released. Do not bend or drop either card.' },
  { id: 'book', button: 'Open Book', title: 'Open Book · Tangential Force', videos: ['/videos/benchmark/book/1.mp4', '/videos/benchmark/book/2.mp4', '/videos/benchmark/book/3.mp4', '/videos/benchmark/book/4.mp4'], ood: [null, 'Unseen book', 'Unseen book', 'Unseen toolkit'], description: 'Begin with the closed book lying flat on the black platform. Use the left hand to separate and lift a thick section of pages near the middle of the book, then turn the section across the spine to open the book to an interior spread. Bring in the right hand to help guide the pages and press the book open and flat. Finish with both hands holding the selected pages flat for at least five seconds. Do not open only the front or back cover, move the book off the platform, or crease or tear any page.' },
  { id: 'balloon', button: 'Draw on Balloon', title: 'Draw on Balloon · Fragile Curved-Surface Contact', videos: ['/videos/benchmark/balloon/1.mp4', '/videos/benchmark/balloon/2.mp4', '/videos/benchmark/balloon/3.mp4'], ood: [null, 'Unseen balloon', 'Unseen balloon'], description: 'Begin with the inflated yellow balloon and the black marker on the table. Gently pick up and steady the balloon with the left hand. Use the right hand to pick up the marker and draw a smiley face with two eyes and a curved smile, maintaining light and continuous contact with the balloon. After completing the drawing, set the marker down, lift and orient the balloon so that the finished face is clearly visible to the audience, and present it with the left hand while giving a thumbs-up beside it with the right hand. Do not let the balloon slip, deform excessively, or pop.' },
  { id: 'cap', button: 'Unscrew Cap', title: 'Unscrew Cap · Rotational Torque', videos: ['/videos/benchmark/cap/1.mp4', '/videos/benchmark/cap/2.mp4', '/videos/benchmark/cap/3.mp4'], ood: [null, 'Unseen bottle', 'Long-horizon'], description: 'Begin with the bottle standing upright on the white tray. Stabilize the bottle with the left hand while using the right hand to grasp the blue cap and turn it counterclockwise until it is completely detached. At the end, place the bottle upright on the white tray and set the cap down on the table beside the tray, then release both objects and move both hands away. Keep the bottle stable throughout, and do not crush, drop, or spill it.' },
